...
const PresetsPanel = React.memo(
  ({
    ...
    <div className="mr-3 min-w-32.5 space-y-1 border-slate-800 border-r pr-3" role="group" aria-label="Quick date presets">
  ...
  return (
    <div className="relative">
      <Popover open={isOpen} onOpenChange={handleOpenChange}>
        ...
        <PopoverContent className="w-auto border-0 bg-transparent p-0 shadow-none z-9999" align="start">
          <CalendarContent
