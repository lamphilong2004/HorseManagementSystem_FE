            ...
            {characters.map((char, i) => (
              ...
              >
                ...
                <motion.span
                  ...
                  className="inline-block font-black leading-none tracking-tighter text-[var(--text)]"
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
                {/* Top Slice Layer */}
                <motion.span
                  ...
                  className="pointer-events-none absolute inset-0 z-10 inline-block font-black leading-none text-amber-500"
                ...
                <motion.span
                  ...
                  className="pointer-events-none absolute inset-0 z-10 inline-block font-black leading-none text-[var(--muted)]"
                  style={{
          ...
          <span className="flex flex-wrap items-center justify-center">
            {characters.map((char, i) => (
              <span
                ...
                className="relative inline-block overflow-hidden px-[0.1vw]"
              >
                <span className="inline-block font-black leading-none tracking-tighter text-[var(--text)]">
                  {char === " " ? "\u00A0" : char}
                </span>
              </span>
            ))}
