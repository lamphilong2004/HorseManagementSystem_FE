    ...
    <div className="h-screen bg-transparent text-(--text) flex flex-col font-sans selection:bg-amber-500/30 selection:text-amber-200 overflow-hidden">
          ...
          <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-[9px] font-semibold text-amber-500">{roleLabel(role)}</span>
              </div>
            </button>
      ...
      <div className="flex flex-1 overflow-hidden">
                ...
                >
                  ...
                  <div
                    className={`
                      ...
                      ${isActive 
                        ? 'text-amber-500' 
                        : 'text-muted hover:text-(--text) hover:bg-(--surface-strong)/40'
                      }
                    `}
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden">
          ...
          {/* Luxury Footer */}
          <footer className="border-t border-border bg-(--surface)/20 py-5 text-center text-xs text-muted">
