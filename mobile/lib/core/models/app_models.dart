...
class Race {
  ...
  factory Race.fromDirect(Map<String, dynamic> json) => Race(
    id: _stringValue(json['id']),
    tournamentId: _stringValue(json['tournamentId']),
    name: _stringValue(json['name']),
    scheduledAt: _stringValue(json['scheduledAt']),
    status: _stringValue(json['status']),
  );
...
class Invite {
  ...
  factory Invite.fromDirect(Map<String, dynamic> json) => Invite(
    id: _stringValue(json['id']),
    horseId: _stringValue(json['horseId']),
    horseName: _stringValue(json['horseName']),
    status: _stringValue(json['status']),
  );
}
...
class Prediction {
  ...
  factory Prediction.fromApi(Map<String, dynamic> json) {
    ...
    final mappedStatus =
        apiStatus == 'OPEN' || apiStatus == 'CLOSED' ? 'PENDING' : apiStatus;
